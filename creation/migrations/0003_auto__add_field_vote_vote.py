...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'creation_vote', 'vote',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'creation_vote', 'vote')
    ...
    models = {
        ...
        u'creation.branch': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['creation.Branch']"}),
        ...
        u'creation.vote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'vote': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
